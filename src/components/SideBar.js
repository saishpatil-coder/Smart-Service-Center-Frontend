...
import { APP_NAME, menuConfig } from "@/constants/app";
    ...
    >
      <div className="h-24 flex items-center px-6 mb-2 relative">
        ...
        <button
          ...
          className={cn(
            "absolute cursor-pointer -right-1 top-10 text-black rounded-full p-1.5 transition-all shadow-xl active:scale-90 z-30 bg-white border border-slate-100",
            collapsed && "right-6",
          )}
        >
